...
| Isomer | $\Delta E_{DFT} + \Delta(H - E_{el,DFT})$ | $\Delta E_{CCSD(T)} + \Delta(H - E_{el,DFT})$ | [$\Delta H_{Exp.}$](https://atct.anl.gov/Thermochemical%20Data/version%201.222/index.php) | Error DFT | Error CCSD(T) |
|---|---|---|---|---|---|
